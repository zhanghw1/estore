	...
	<div class="content">
		<div class="contentCenter">
			...
			<form action="user/toOrderListServlet" name="orderForm">
				...
				<div class="centerTop">
					<b style="font-size: 20px;">收货人信息</b> <b
						style="float: right; cursor: pointer;" onclick="showAdres(this);"
						ondblclick="hideAdres(this);">新增收货地址</b>
					<ul class="adres">
						<c:forEach items="${addresslist }" var="address">
							<li><input type="radio" name="shopAddId"
								value="${address.id }" style="width: 50px">收货人姓名:${address.receiveName }&nbsp;&nbsp;&nbsp;收货电话:${address.phone }&nbsp;&nbsp;&nbsp;收货地址:${address.address }</li>
						</c:forEach>
					</ul>
				...
				<p class="singleP">
					<b>送货清单</b><span><a href="shopCart.html">返回修改购物车</a></span>
				</p>
				<div class="bigDiv">
					<div class="twoDiv">
						<b>商家：briup自营</b>
						<c:forEach items="${car.orderLines }" var="entry">
							<ul class="oneUL">
								<li><img src="${entry.value.book.image }" class="pic">
									<p>${entry.value.book.description }&nbsp;&nbsp;&nbsp;${entry.value.book.name }</p>
									<p>
										<font>¥${entry.value.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${entry.value.num }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货
									</p>
									<p>
				...
				<div class="money">
					<span><font>${car.sumNum }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.sumNum }*2</span>
					<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

					<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost }</span>
				</div>
				<div class="submit">
					<span>应付金额：<font>¥${car.cost }</font><input type="image"
						src="images/21_03.png"></span>
				</div>
			</form>
		</div>
