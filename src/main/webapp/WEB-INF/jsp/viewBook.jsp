	...
	<div class="container5">
		<div class="cn5_top">
			<div class="cn5_top_x center01">
				<a class="font20" href="#">书籍</a> > <a href="#">${book.description }</a>
			</div>
				...
				<div class="cn5topy_2">
					...
					<div class="pro_price">
						<div class="pro_price_x">
							<p>
								briup价：<b>￥${book.price }</b> <a href="#">(降价通知)</a>
							</p>
						</div>
					...
					<div class="pro_selects">
						...
						<div class="pro_select">
							...
							<ul class="pro_select_vals">
								<li>出版时间：<fmt:formatDate pattern="yyyy-MM-dd"
										value="${book.pubDate}" />
								</li>
								<li>包装：平装</li>
								<li>正文语种：中文</li>
					...
					<form action="user/addShopCartServlet" id="addCar">
						<div class="pro_buy">
		...
		<div class="c5_b2">
			...
			<div class="c5_b2_right">
				...
				<div class="intro_pics">
					<img class="intro_pic" src="${book.image }">
				</div>
			</div>
