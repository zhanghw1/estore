				...
				<c:forEach items="${topBooklist }" var="book">
					<li><img src="${book.image }">
						<div class="c4_b1_box_txt">
							...
							<h2>
								<a href="toViewBookServlet?id=${book.id }">立即抢购</a>
							</h2>
						</div></li>
				</c:forEach>
			</ul>
						...
						<li class="c4_b5_c_box">
							...
							<div class="c4_b5_c_box_pic">
								<div class="c4b5_pic_view">
									<a href="toViewBookServlet?id=${book.id }"><img
										src="${book.image }"></a>
								</div>
							</div> <!--价钱-->
							<div class="c4_b5_c_box_txt">
								<h1>￥ ${book.price }</h1>
								<h2>
									<a href="toViewBookServlet?id=${book.id }">${book.name }</a>
								</h2>
							</div> <!--购买等操作-->
							<div class="c4b5_el">
								<div class="c4b5_el_x">
